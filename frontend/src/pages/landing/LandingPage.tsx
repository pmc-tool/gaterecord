...
const features = [
  ...
  },
  {
    ...
    description: 'Perfect for property managers handling multiple buildings or communities.',
    icon: UserGroupIcon,
  },
  {
...
const steps = [
  {
    ...
    description: 'Our ESP32-based controllers integrate with existing gate systems in under an hour.',
          ...
          <div className="lg:hidden fixed inset-0 z-50 bg-white">
            ...
            <div className="mt-6 flow-root px-6">
              ...
              <div className="py-6 space-y-3">
                <Link
                  to="/login"
                  className="block text-center rounded-lg px-3 py-2.5 text-base font-medium text-gray-900 hover:bg-gray-50"
                >
                  Sign in
                </Link>
                <Link
                  to="/signup"
                  className="block text-center rounded-full px-3 py-2.5 text-base font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600"
                >
                  Get Started
                </Link>
              </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
            <div className="max-w-2xl mx-auto lg:mx-0 lg:col-span-7 lg:pt-8">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <Link
                  to="/signup"
                  className="w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:from-blue-700 hover:to-indigo-700 transition-all"
                >
                  Start Free Trial
                </Link>
                <a
                  href="#how-it-works"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 text-base font-semibold text-gray-900 hover:text-blue-600 transition-colors px-4 py-4"
                >
            ...
            {pricing.map((plan) => (
              ...
              >
                ...
                <p className="mt-6 flex items-baseline gap-x-1">
                  {plan.price !== 'Custom' && <span className={`text-sm ${plan.popular ? 'text-blue-100' : 'text-gray-400'}`}>$</span>}
                ...
                <Link
                  ...
                  className={`mt-8 block rounded-full py-3 px-4 text-center text-sm font-semibold transition-all ${
                    plan.popular
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/signup"
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-white px-8 py-4 text-base font-semibold text-blue-600 shadow-lg hover:bg-blue-50 transition-all"
            >
              Start Free Trial
            </Link>
            <a
              href="mailto:sales@gaterecord.com"
              className="w-full sm:w-auto inline-flex items-center justify-center rounded-full ring-2 ring-white/30 px-8 py-4 text-base font-semibold text-white hover:bg-white/10 transition-all"
            >
              Contact Sales
            </a>
          </div>
